import os
from payload.model.phase_noise import PhaseNoise, ChainPhaseNoise
...
class TestCasePhaseNoise:
    ...
    def test_calc_rms_deg_data(self):
        freq, dbc, dbc_spec = [], [], []
        fixture_path = '/payload/test/__fixtures__/'
        filename = 'phase_noise_s_ka.txt'
        fixture_full_filename = ''.join([os.getcwd(), fixture_path, filename])
        with open(fixture_full_filename, 'r') as f:
